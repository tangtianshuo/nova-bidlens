...
import type { CompareResult } from '@bidlens/shared/types-only';
import { ReviewWorkbench } from './ReviewWorkbench';

function makeResult(overrides: Partial<CompareResult> & Pick<CompareResult, 'diffAst'>): CompareResult {
  return {
    taskId: 't1',
...
describe('ReviewWorkbench', () => {
  it('renders navigation, document panes, and details for text diff', () => {
    render(<ReviewWorkbench result={makeResult({
      diffAst: {
        taskId: 't1',
        docAId: 'a',
        docBId: 'b',
