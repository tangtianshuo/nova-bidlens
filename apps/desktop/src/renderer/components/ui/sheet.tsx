...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-[var(--color-bg)] border-[var(--color-border)] p-[var(--layout-dialog-x)] shadow-[var(--shadow-overlay)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
